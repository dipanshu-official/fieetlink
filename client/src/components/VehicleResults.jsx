...
export default function VehicleResults({ results, onBookVehicle, loading = false }) {
  if (loading) {
    return (
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Searching for vehicles...</h2>
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center">
                    ...
                    <span>{vehicle.estimatedDistance} km</span>
                  </div>
                  <div className="flex items-center">
